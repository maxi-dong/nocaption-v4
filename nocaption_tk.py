    ...
    def _toggle_mode(self):
        ...
        for child in self.random_frame.winfo_children():
            if "state" in child.keys():
                child.configure(state="normal" if is_random else "disabled")
        for child in self.struct_frame.winfo_children():
            if "state" in child.keys():
                child.configure(state="normal" if not is_random else "disabled")
